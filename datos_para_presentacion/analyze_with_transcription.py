...
def create_comparison_visualizations(analyzers, stats_results, girls_vowels, boys_vowels):
    ...
    axes[0, 0].set_title('Distribución de tono por género', fontweight='bold')
    axes[0, 0].legend()
    ...
    axes[0, 1].set_title('Comparación de tono', fontweight='bold')
    ...
    axes[1, 0].set_title('Comparación de F1 (primer formante)', fontweight='bold')
    ...
    axes[1, 1].set_title('Comparación de F2 (segundo formante)', fontweight='bold')
